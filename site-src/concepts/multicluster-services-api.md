...
This document solely focuses on the API and the common behaviour, leaving room for various [implementations](../implementations/index.md). There is no reference implementation available.
